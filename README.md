...
Developer-friendly & type-safe Php SDK specifically catered to leverage *pago-sh/sdk* API.

<div align="left">
    <a href="https://www.speakeasy.com/?utm_source=pago-sh/sdk&utm_campaign=php"><img src="https://custom-icon-badges.demolab.com/badge/-Built%20By%20Speakeasy-212015?style=for-the-badge&logoColor=FBE331&logo=speakeasy&labelColor=545454" /></a>
...
<br /><br />
> [!IMPORTANT]
> This SDK is not yet ready for production use. To complete setup please follow the steps outlined in your [workspace](https://app.speakeasy.com/org/pago/pago). Delete this section before > publishing to a package manager.
...
use Pago;
use Pago\Models\Operations;

$sdk = Pago\Pago::builder()->build();
...
$sdk = Pago\Pago::builder()
    ->setServerURL('https://api.pago.sh')
    ->setSecurity(
        '<YOUR_BEARER_TOKEN_HERE>'
    )
    ->build();
...
### SDK Created by [Speakeasy](https://www.speakeasy.com/?utm_source=pago-sh/sdk&utm_campaign=php)
