...
class Products
{
     ...
     *
     * @param  \Pago\Models\Components\ProductCreateRecurring|\Pago\Models\Components\ProductCreateOneTime  $request
     * @return \Pago\Models\Operations\ProductsCreateResponse
    ...
    public function create(Components\ProductCreateRecurring|Components\ProductCreateOneTime $request, ?Options $options = null): Operations\ProductsCreateResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['201'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $obj = $serializer->deserialize($responseData, '\Pago\Models\Components\Product', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
     ...
     *
     * @param  string  $id
     * @return \Pago\Models\Operations\ProductsGetResponse
     * @throws \Pago\Models\Errors\APIException
     */
     ...
     * **Scopes**: `products:read` `products:write`
     *
     * @param  ?\Pago\Models\Operations\ProductsListRequest  $request
     * @return \Pago\Models\Operations\ProductsListResponse
     * @throws \Pago\Models\Errors\APIException
     */
    private function listIndividual(?Operations\ProductsListRequest $request = null, ?Options $options = null): Operations\ProductsListResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\Pago\Models\Components\ListResourceProduct', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
     ...
     *
     * @param  ?\Pago\Models\Operations\ProductsListRequest  $request
     * @return \Generator<\Pago\Models\Operations\ProductsListResponse>
     * @throws \Pago\Models\Errors\APIException
     */
     ...
     * @param  string  $id
     * @return \Pago\Models\Operations\ProductsUpdateResponse
     * @throws \Pago\Models\Errors\APIException
     */
     ...
     * @param  string  $id
     * @return \Pago\Models\Operations\ProductsUpdateBenefitsResponse
     * @throws \Pago\Models\Errors\APIException
     */
