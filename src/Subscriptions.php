...
class Subscriptions
{
     ...
     *
     * @param  \Pago\Models\Components\SubscriptionCreateCustomer|\Pago\Models\Components\SubscriptionCreateExternalCustomer  $request
     * @return \Pago\Models\Operations\SubscriptionsCreateResponse
    ...
    public function create(Components\SubscriptionCreateCustomer|Components\SubscriptionCreateExternalCustomer $request, ?Options $options = null): Operations\SubscriptionsCreateResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['201'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $obj = $serializer->deserialize($responseData, '\Pago\Models\Components\Subscription', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
     ...
     * @return \Pago\Models\Operations\SubscriptionsExportResponse
     * @throws \Pago\Models\Errors\APIException
     */
     ...
     *
     * @param  string  $id
     * @return \Pago\Models\Operations\SubscriptionsGetResponse
     * @throws \Pago\Models\Errors\APIException
     */
     ...
     * **Scopes**: `subscriptions:read` `subscriptions:write`
     *
     * @param  ?\Pago\Models\Operations\SubscriptionsListRequest  $request
     * @return \Pago\Models\Operations\SubscriptionsListResponse
     * @throws \Pago\Models\Errors\APIException
     */
    private function listIndividual(?Operations\SubscriptionsListRequest $request = null, ?Options $options = null): Operations\SubscriptionsListResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\Pago\Models\Components\ListResourceSubscription', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
     ...
     *
     * @param  ?\Pago\Models\Operations\SubscriptionsListRequest  $request
     * @return \Generator<\Pago\Models\Operations\SubscriptionsListResponse>
     * @throws \Pago\Models\Errors\APIException
     */
     ...
     *
     * @param  string  $id
     * @return \Pago\Models\Operations\SubscriptionsRevokeResponse
     * @throws \Pago\Models\Errors\APIException
     */
    public function revoke(string $id, ?Options $options = null): Operations\SubscriptionsRevokeResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            ...
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\Pago\Models\Errors\AlreadyCanceledSubscription', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
                throw $obj->toException();
            } else {
                throw new \Pago\Models\Errors\APIException('Unknown content type received', $statusCode, $httpResponse->getBody()->getContents(), $httpResponse);
            }
            ...
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\Pago\Models\Errors\SubscriptionLocked', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
                throw $obj->toException();
            } else {
                throw new \Pago\Models\Errors\APIException('Unknown content type received', $statusCode, $httpResponse->getBody()->getContents(), $httpResponse);
            }
     ...
     * @param  string  $id
     * @return \Pago\Models\Operations\SubscriptionsUpdateResponse
     * @throws \Pago\Models\Errors\APIException
     */
    public function update(Components\SubscriptionUpdateProduct|Components\SubscriptionUpdateDiscount|Components\SubscriptionUpdateTrial|Components\SubscriptionUpdateSeats|Components\SubscriptionUpdateBillingPeriod|Components\SubscriptionCancel|Components\SubscriptionRevoke $subscriptionUpdate, string $id, ?Options $options = null): Operations\SubscriptionsUpdateResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            ...
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\Pago\Models\Errors\PaymentFailed', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
                throw $obj->toException();
            } else {
                throw new \Pago\Models\Errors\APIException('Unknown content type received', $statusCode, $httpResponse->getBody()->getContents(), $httpResponse);
            }
