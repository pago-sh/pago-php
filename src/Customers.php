...
class Customers
{
     ...
     *
     * @param  \Pago\Models\Components\CustomerIndividualCreate|\Pago\Models\Components\CustomerTeamCreate  $request
     * @return \Pago\Models\Operations\CustomersCreateResponse
    ...
    public function create(Components\CustomerIndividualCreate|Components\CustomerTeamCreate $request, ?Options $options = null): Operations\CustomersCreateResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['201'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $obj = $serializer->deserialize($responseData, '\Pago\Models\Components\CustomerIndividual|\Pago\Models\Components\CustomerTeam', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
     ...
     * @return \Pago\Models\Operations\CustomersDeleteResponse
     * @throws \Pago\Models\Errors\APIException
     */
     ...
     * @param  ?bool  $anonymize
     * @return \Pago\Models\Operations\CustomersDeleteExternalResponse
     * @throws \Pago\Models\Errors\APIException
     */
     ...
     * @return \Pago\Models\Operations\CustomersExportResponse
     * @throws \Pago\Models\Errors\APIException
     */
     ...
     *
     * @param  string  $id
     * @return \Pago\Models\Operations\CustomersGetResponse
     * @throws \Pago\Models\Errors\APIException
     */
     ...
     *
     * @param  string  $externalId
     * @return \Pago\Models\Operations\CustomersGetExternalResponse
     * @throws \Pago\Models\Errors\APIException
     */
     ...
     *
     * @param  string  $id
     * @return \Pago\Models\Operations\CustomersGetStateResponse
     * @throws \Pago\Models\Errors\APIException
     */
    public function getState(string $id, ?Options $options = null): Operations\CustomersGetStateResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\Pago\Models\Components\CustomerStateIndividual|\Pago\Models\Components\CustomerStateTeam', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
     ...
     *
     * @param  string  $externalId
     * @return \Pago\Models\Operations\CustomersGetStateExternalResponse
     * @throws \Pago\Models\Errors\APIException
     */
     ...
     * **Scopes**: `customers:read` `customers:write`
     *
     * @param  ?\Pago\Models\Operations\CustomersListRequest  $request
     * @return \Pago\Models\Operations\CustomersListResponse
     * @throws \Pago\Models\Errors\APIException
     */
    private function listIndividual(?Operations\CustomersListRequest $request = null, ?Options $options = null): Operations\CustomersListResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\Pago\Models\Components\ListResourceCustomer', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
     ...
     *
     * @param  ?\Pago\Models\Operations\CustomersListRequest  $request
     * @return \Generator<\Pago\Models\Operations\CustomersListResponse>
     * @throws \Pago\Models\Errors\APIException
     */
     ...
     * @param  string  $id
     * @return \Pago\Models\Operations\CustomersUpdateResponse
     * @throws \Pago\Models\Errors\APIException
     */
     ...
     * @param  string  $externalId
     * @return \Pago\Models\Operations\CustomersUpdateExternalResponse
     * @throws \Pago\Models\Errors\APIException
     */
