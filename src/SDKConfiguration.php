...
namespace Pago;
use Pago\Utils\Retry\RetryConfig;
...
class SDKConfiguration
{
    ...
    public string $userAgent = 'speakeasy-sdk/php 0.10.0 2.879.6 0.1.0 pago-sh/sdk';
    ...
    public function getServerUrl(): string
    {
        ...
        if ($this->server === '') {
            $this->server = Pago::SERVER_PRODUCTION;
        }

        return Pago::SERVERS[$this->server];
    }
    ...
    public function getServerDetails(): Utils\ServerDetails
    {
        ...
        return new Utils\ServerDetails(Pago::SERVERS[$this->server], []);
