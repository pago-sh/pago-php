...
class Wallets
{
     ...
     *
     * @param  \Pago\Models\Operations\CustomerPortalWalletsGetSecurity  $security
     * @param  string  $id
     * @return \Pago\Models\Operations\CustomerPortalWalletsGetResponse
    ...
    public function get(Operations\CustomerPortalWalletsGetSecurity $security, string $id, ?Options $options = null): Operations\CustomerPortalWalletsGetResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $obj = $serializer->deserialize($responseData, '\Pago\Models\Components\CustomerWallet', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
     ...
     *
     * @param  \Pago\Models\Operations\CustomerPortalWalletsListSecurity  $security
     * @param  ?int  $page
     * @param  ?int  $limit
     * @param  ?array<\Pago\Models\Components\CustomerWalletSortProperty>  $sorting
     * @return \Pago\Models\Operations\CustomerPortalWalletsListResponse
     * @throws \Pago\Models\Errors\APIException
     */
    private function listIndividual(Operations\CustomerPortalWalletsListSecurity $security, ?int $page = null, ?int $limit = null, ?array $sorting = null, ?Options $options = null): Operations\CustomerPortalWalletsListResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\Pago\Models\Components\ListResourceCustomerWallet', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
     ...
     * @param  ?int  $limit
     * @param  ?array<\Pago\Models\Components\CustomerWalletSortProperty>  $sorting
     * @return \Generator<\Pago\Models\Operations\CustomerPortalWalletsListResponse>
     * @throws \Pago\Models\Errors\APIException
     */
