...
class PagoCustomers
{
     ...
     *
     * @param  \Pago\Models\Operations\CustomerPortalCustomersAddPaymentMethodSecurity  $security
     * @param  \Pago\Models\Components\CustomerPaymentMethodCreate  $request
     * @return \Pago\Models\Operations\CustomerPortalCustomersAddPaymentMethodResponse
    ...
    public function addPaymentMethod(Operations\CustomerPortalCustomersAddPaymentMethodSecurity $security, Components\CustomerPaymentMethodCreate $request, ?Options $options = null): Operations\CustomerPortalCustomersAddPaymentMethodResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['201'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $obj = $serializer->deserialize($responseData, '\Pago\Models\Components\CustomerPaymentMethodCreateSucceededResponse|\Pago\Models\Components\CustomerPaymentMethodCreateRequiresActionResponse', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
     ...
     *
     * @param  \Pago\Models\Operations\CustomerPortalCustomersConfirmPaymentMethodSecurity  $security
     * @param  \Pago\Models\Components\CustomerPaymentMethodConfirm  $request
     * @return \Pago\Models\Operations\CustomerPortalCustomersConfirmPaymentMethodResponse
     * @throws \Pago\Models\Errors\APIException
     */
    public function confirmPaymentMethod(Operations\CustomerPortalCustomersConfirmPaymentMethodSecurity $security, Components\CustomerPaymentMethodConfirm $request, ?Options $options = null): Operations\CustomerPortalCustomersConfirmPaymentMethodResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['201'])) {
            ...
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\Pago\Models\Errors\CustomerNotReady', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
                throw $obj->toException();
            } else {
                throw new \Pago\Models\Errors\APIException('Unknown content type received', $statusCode, $httpResponse->getBody()->getContents(), $httpResponse);
            }
     ...
     *
     * @param  \Pago\Models\Operations\CustomerPortalCustomersDeletePaymentMethodSecurity  $security
     * @param  string  $id
     * @return \Pago\Models\Operations\CustomerPortalCustomersDeletePaymentMethodResponse
     * @throws \Pago\Models\Errors\APIException
     */
    public function deletePaymentMethod(Operations\CustomerPortalCustomersDeletePaymentMethodSecurity $security, string $id, ?Options $options = null): Operations\CustomerPortalCustomersDeletePaymentMethodResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['204'])) {
            ...
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\Pago\Models\Errors\PaymentMethodInUseByActiveSubscription', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
                throw $obj->toException();
            } else {
                throw new \Pago\Models\Errors\APIException('Unknown content type received', $statusCode, $httpResponse->getBody()->getContents(), $httpResponse);
            }
     ...
     *
     * @param  \Pago\Models\Operations\CustomerPortalCustomersGetSecurity  $security
     * @return \Pago\Models\Operations\CustomerPortalCustomersGetResponse
     * @throws \Pago\Models\Errors\APIException
     */
    public function get(Operations\CustomerPortalCustomersGetSecurity $security, ?Options $options = null): Operations\CustomerPortalCustomersGetResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\Pago\Models\Components\CustomerPortalCustomer', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
     ...
     *
     * @param  \Pago\Models\Operations\CustomerPortalCustomersListPaymentMethodsSecurity  $security
     * @param  ?int  $page
     * @param  ?int  $limit
     * @return \Pago\Models\Operations\CustomerPortalCustomersListPaymentMethodsResponse
     * @throws \Pago\Models\Errors\APIException
     */
    private function listPaymentMethodsIndividual(Operations\CustomerPortalCustomersListPaymentMethodsSecurity $security, ?int $page = null, ?int $limit = null, ?Options $options = null): Operations\CustomerPortalCustomersListPaymentMethodsResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\Pago\Models\Components\ListResourceCustomerPaymentMethod', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
     ...
     * @param  ?int  $page
     * @param  ?int  $limit
     * @return \Generator<\Pago\Models\Operations\CustomerPortalCustomersListPaymentMethodsResponse>
     * @throws \Pago\Models\Errors\APIException
     */
     ...
     *
     * @param  \Pago\Models\Operations\CustomerPortalCustomersUpdateSecurity  $security
     * @param  \Pago\Models\Components\CustomerPortalCustomerUpdate  $request
     * @return \Pago\Models\Operations\CustomerPortalCustomersUpdateResponse
     * @throws \Pago\Models\Errors\APIException
     */
