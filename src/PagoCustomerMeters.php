...
class PagoCustomerMeters
{
     ...
     *
     * @param  \Pago\Models\Operations\CustomerPortalCustomerMetersGetSecurity  $security
     * @param  string  $id
     * @return \Pago\Models\Operations\CustomerPortalCustomerMetersGetResponse
    ...
    public function get(Operations\CustomerPortalCustomerMetersGetSecurity $security, string $id, ?Options $options = null): Operations\CustomerPortalCustomerMetersGetResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $obj = $serializer->deserialize($responseData, '\Pago\Models\Components\CustomerCustomerMeter', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
     ...
     * **Scopes**: `customer_portal:read` `customer_portal:write`
     *
     * @param  \Pago\Models\Operations\CustomerPortalCustomerMetersListSecurity  $security
     * @param  ?\Pago\Models\Operations\CustomerPortalCustomerMetersListRequest  $request
     * @return \Pago\Models\Operations\CustomerPortalCustomerMetersListResponse
     * @throws \Pago\Models\Errors\APIException
     */
    private function listIndividual(Operations\CustomerPortalCustomerMetersListSecurity $security, ?Operations\CustomerPortalCustomerMetersListRequest $request = null, ?Options $options = null): Operations\CustomerPortalCustomerMetersListResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\Pago\Models\Components\ListResourceCustomerCustomerMeter', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
     ...
     * @param  \Pago\Models\Operations\CustomerPortalCustomerMetersListSecurity  $security
     * @param  ?\Pago\Models\Operations\CustomerPortalCustomerMetersListRequest  $request
     * @return \Generator<\Pago\Models\Operations\CustomerPortalCustomerMetersListResponse>
     * @throws \Pago\Models\Errors\APIException
     */
