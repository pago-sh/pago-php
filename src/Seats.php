...
class Seats
{
     ...
     * Assign Seat
     *
     * @param  \Pago\Models\Operations\CustomerPortalSeatsAssignSeatSecurity  $security
     * @param  \Pago\Models\Components\SeatAssign  $request
     * @return \Pago\Models\Operations\CustomerPortalSeatsAssignSeatResponse
    ...
    public function assignSeat(Operations\CustomerPortalSeatsAssignSeatSecurity $security, Components\SeatAssign $request, ?Options $options = null): Operations\CustomerPortalSeatsAssignSeatResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $obj = $serializer->deserialize($responseData, '\Pago\Models\Components\CustomerSeat', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
     ...
     *
     * @param  \Pago\Models\Operations\CustomerPortalSeatsListClaimedSubscriptionsSecurity  $security
     * @param  ?int  $page
     * @param  ?int  $limit
     * @return \Pago\Models\Operations\CustomerPortalSeatsListClaimedSubscriptionsResponse
     * @throws \Pago\Models\Errors\APIException
     */
     ...
     * @param  ?int  $page
     * @param  ?int  $limit
     * @return \Generator<\Pago\Models\Operations\CustomerPortalSeatsListClaimedSubscriptionsResponse>
     * @throws \Pago\Models\Errors\APIException
     */
     ...
     * **Scopes**: `customer_portal:read` `customer_portal:write`
     *
     * @param  \Pago\Models\Operations\CustomerPortalSeatsListSeatsSecurity  $security
     * @param  ?string  $subscriptionId
     * @param  ?string  $orderId
     * @return \Pago\Models\Operations\CustomerPortalSeatsListSeatsResponse
     * @throws \Pago\Models\Errors\APIException
     */
    public function listSeats(Operations\CustomerPortalSeatsListSeatsSecurity $security, ?string $subscriptionId = null, ?string $orderId = null, ?Options $options = null): Operations\CustomerPortalSeatsListSeatsResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\Pago\Models\Components\SeatsList', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
     ...
     * Resend Invitation
     *
     * @param  \Pago\Models\Operations\CustomerPortalSeatsResendInvitationSecurity  $security
     * @param  string  $seatId
     * @return \Pago\Models\Operations\CustomerPortalSeatsResendInvitationResponse
     * @throws \Pago\Models\Errors\APIException
     */
     ...
     * Revoke Seat
     *
     * @param  \Pago\Models\Operations\CustomerPortalSeatsRevokeSeatSecurity  $security
     * @param  string  $seatId
     * @return \Pago\Models\Operations\CustomerPortalSeatsRevokeSeatResponse
     * @throws \Pago\Models\Errors\APIException
     */
