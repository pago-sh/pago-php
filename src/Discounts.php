...
class Discounts
{
     ...
     *
     * @param  \Pago\Models\Components\DiscountFixedOnceForeverDurationCreate|\Pago\Models\Components\DiscountFixedRepeatDurationCreate|\Pago\Models\Components\DiscountPercentageOnceForeverDurationCreate|\Pago\Models\Components\DiscountPercentageRepeatDurationCreate  $request
     * @return \Pago\Models\Operations\DiscountsCreateResponse
    ...
    public function create(Components\DiscountFixedOnceForeverDurationCreate|Components\DiscountFixedRepeatDurationCreate|Components\DiscountPercentageOnceForeverDurationCreate|Components\DiscountPercentageRepeatDurationCreate $request, ?Options $options = null): Operations\DiscountsCreateResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['201'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $obj = $serializer->deserialize($responseData, '\Pago\Models\Components\DiscountFixedOnceForeverDuration|\Pago\Models\Components\DiscountFixedRepeatDuration|\Pago\Models\Components\DiscountPercentageOnceForeverDuration|\Pago\Models\Components\DiscountPercentageRepeatDuration', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
     ...
     *
     * @param  string  $id
     * @return \Pago\Models\Operations\DiscountsDeleteResponse
     * @throws \Pago\Models\Errors\APIException
     */
     ...
     *
     * @param  string  $id
     * @return \Pago\Models\Operations\DiscountsGetResponse
     * @throws \Pago\Models\Errors\APIException
     */
     ...
     * **Scopes**: `discounts:read` `discounts:write`
     *
     * @param  ?\Pago\Models\Operations\DiscountsListRequest  $request
     * @return \Pago\Models\Operations\DiscountsListResponse
     * @throws \Pago\Models\Errors\APIException
     */
    private function listIndividual(?Operations\DiscountsListRequest $request = null, ?Options $options = null): Operations\DiscountsListResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\Pago\Models\Components\ListResourceDiscount', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
     ...
     *
     * @param  ?\Pago\Models\Operations\DiscountsListRequest  $request
     * @return \Generator<\Pago\Models\Operations\DiscountsListResponse>
     * @throws \Pago\Models\Errors\APIException
     */
     ...
     * @param  string  $id
     * @return \Pago\Models\Operations\DiscountsUpdateResponse
     * @throws \Pago\Models\Errors\APIException
     */
