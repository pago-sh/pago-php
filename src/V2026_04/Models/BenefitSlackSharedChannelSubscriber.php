 ...
 */
final class BenefitSlackSharedChannelSubscriber implements Model, Deserializable
{
    public function __construct(
        ...
        public readonly BenefitSlackSharedChannelSubscriberProperties $properties,
    ) {
    }
    ...
    public static function fromArray(array $data): self
    {
        ...
        $properties = BenefitSlackSharedChannelSubscriberProperties::fromArray(Json::toMap(Json::get($data, 'properties')));
