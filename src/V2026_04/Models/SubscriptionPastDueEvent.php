 ...
 */
final class SubscriptionPastDueEvent implements Model, Deserializable, SystemEvent
{
    public function __construct(
        ...
        public readonly SubscriptionPastDueMetadata $metadata,
        /**
         * @var string|null
         */
    ...
    public static function fromArray(array $data): self
    {
        ...
        $metadata = SubscriptionPastDueMetadata::fromArray(Json::toMap(Json::get($data, 'metadata')));
