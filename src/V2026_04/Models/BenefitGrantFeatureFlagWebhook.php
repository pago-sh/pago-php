 ...
 */
final class BenefitGrantFeatureFlagWebhook implements Model, Deserializable, BenefitGrantWebhook
{
    public function __construct(
        ...
        public readonly BenefitFeatureFlag $benefit,
        public readonly BenefitGrantFeatureFlagProperties $properties,
        /**
         * @var string|null
         */
        ...
        /**
         * @var BenefitGrantFeatureFlagProperties|null
         */
        public readonly ?BenefitGrantFeatureFlagProperties $previous_properties = null,
    ) {
    }
    ...
    public static function fromArray(array $data): self
    {
        ...
        $benefit = BenefitFeatureFlag::fromArray(Json::toMap(Json::get($data, 'benefit')));
        $properties = BenefitGrantFeatureFlagProperties::fromArray(Json::toMap(Json::get($data, 'properties')));
        ...
        /** @var BenefitGrantFeatureFlagProperties|null $previous_properties */
        $previous_properties = isset($data['previous_properties']) ? BenefitGrantFeatureFlagProperties::fromArray(Json::toMap($data['previous_properties'])) : null;
