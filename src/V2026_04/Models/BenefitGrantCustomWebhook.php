 ...
 */
final class BenefitGrantCustomWebhook implements Model, Deserializable, BenefitGrantWebhook
{
    public function __construct(
        ...
        public readonly BenefitCustom $benefit,
        public readonly BenefitGrantCustomProperties $properties,
        /**
         * @var string|null
         */
        ...
        /**
         * @var BenefitGrantCustomProperties|null
         */
        public readonly ?BenefitGrantCustomProperties $previous_properties = null,
    ) {
    }
    ...
    public static function fromArray(array $data): self
    {
        ...
        $benefit = BenefitCustom::fromArray(Json::toMap(Json::get($data, 'benefit')));
        $properties = BenefitGrantCustomProperties::fromArray(Json::toMap(Json::get($data, 'properties')));
        ...
        /** @var BenefitGrantCustomProperties|null $previous_properties */
        $previous_properties = isset($data['previous_properties']) ? BenefitGrantCustomProperties::fromArray(Json::toMap($data['previous_properties'])) : null;
