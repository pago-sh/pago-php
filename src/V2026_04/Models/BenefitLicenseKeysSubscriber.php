 ...
 */
final class BenefitLicenseKeysSubscriber implements Model, Deserializable
{
    public function __construct(
        ...
        public readonly BenefitLicenseKeysSubscriberProperties $properties,
    ) {
    }
    ...
    public static function fromArray(array $data): self
    {
        ...
        $properties = BenefitLicenseKeysSubscriberProperties::fromArray(Json::toMap(Json::get($data, 'properties')));
