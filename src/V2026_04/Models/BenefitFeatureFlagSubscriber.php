 ...
 */
final class BenefitFeatureFlagSubscriber implements Model, Deserializable
{
    public function __construct(
        ...
        public readonly BenefitFeatureFlagSubscriberProperties $properties,
    ) {
    }
    ...
    public static function fromArray(array $data): self
    {
        ...
        $properties = BenefitFeatureFlagSubscriberProperties::fromArray(Json::toMap(Json::get($data, 'properties')));
