 ...
 */
final class CustomerBenefitGrantSlackSharedChannel implements Model, Deserializable, CustomerBenefitGrant
{
    public function __construct(
        ...
        public readonly BenefitSlackSharedChannelSubscriber $benefit,
    ...
    public static function fromArray(array $data): self
    {
        ...
        $benefit = BenefitSlackSharedChannelSubscriber::fromArray(Json::toMap(Json::get($data, 'benefit')));
