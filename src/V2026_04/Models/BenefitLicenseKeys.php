 ...
 * BenefitLicenseKeys
 */
final class BenefitLicenseKeys implements Model, Deserializable, Benefit
{
    public function __construct(
        ...
        public readonly BenefitLicenseKeysProperties $properties,
    ...
    public static function fromArray(array $data): self
    {
        ...
        $properties = BenefitLicenseKeysProperties::fromArray(Json::toMap(Json::get($data, 'properties')));
