 ...
 */
final class BenefitMeterCreditCreate implements Model, Deserializable, BenefitCreate
{
    ...
    public static function fromArray(array $data): self
    {
        ...
        $properties = BenefitMeterCreditCreateProperties::fromArray(Json::toMap(Json::get($data, 'properties')));
