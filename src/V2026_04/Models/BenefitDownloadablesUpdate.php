 ...
 */
final class BenefitDownloadablesUpdate implements Model, Deserializable
{
    public function __construct(
        ...
        /**
         * @var BenefitDownloadablesCreateProperties|null
         */
    ...
    public static function fromArray(array $data): self
    {
        ...
        /** @var BenefitDownloadablesCreateProperties|null $properties */
        $properties = isset($data['properties']) ? BenefitDownloadablesCreateProperties::fromArray(Json::toMap($data['properties'])) : null;
