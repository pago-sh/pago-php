 ...
 */
final class CustomFieldUpdateCheckbox implements Model, Deserializable, CustomFieldUpdate
{
    public function __construct(
        ...
        /**
         * @var CustomFieldCheckboxProperties|null
         */
    ...
    public static function fromArray(array $data): self
    {
        ...
        /** @var CustomFieldCheckboxProperties|null $properties */
        $properties = isset($data['properties']) ? CustomFieldCheckboxProperties::fromArray(Json::toMap($data['properties'])) : null;
