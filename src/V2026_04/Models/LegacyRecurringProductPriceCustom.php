 ...
 */
final class LegacyRecurringProductPriceCustom implements Model, Deserializable, LegacyRecurringProductPrice
{
    public function __construct(
         ...
         * @var int|null
         */
        public readonly ?int $maximum_amount,
        /**
         * @var int|null
         */
        public readonly ?int $preset_amount,
    ...
    public static function fromArray(array $data): self
    {
        ...
        $minimum_amount = Json::toInt(Json::get($data, 'minimum_amount'));
        /** @var int|null $maximum_amount */
        $maximum_amount = (Json::get($data, 'maximum_amount') === null ? null : Json::toInt(Json::get($data, 'maximum_amount')));
        /** @var int|null $preset_amount */
        $preset_amount = (Json::get($data, 'preset_amount') === null ? null : Json::toInt(Json::get($data, 'preset_amount')));
