 ...
 */
final class CheckoutLinkCreateProductPrice implements Model, Deserializable, CheckoutLinkCreate
{
    ...
    public static function fromArray(array $data): self
    {
        ...
        $product_price_id = Json::toString(Json::get($data, 'product_price_id'));
