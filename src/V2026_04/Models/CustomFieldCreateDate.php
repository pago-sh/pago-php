 ...
 */
final class CustomFieldCreateDate implements Model, Deserializable, CustomFieldCreate
{
    ...
    public static function fromArray(array $data): self
    {
        ...
        $properties = CustomFieldDateProperties::fromArray(Json::toMap(Json::get($data, 'properties')));
