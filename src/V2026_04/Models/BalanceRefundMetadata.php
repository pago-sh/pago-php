 ...
 */
final class BalanceRefundMetadata implements Model, Deserializable
{
    public function __construct(
        ...
        public readonly int $presentment_amount,
        public readonly string $presentment_currency,
         ...
         * @var string|null
         */
        public readonly ?string $order_created_at = null,
        /**
         * @var string|null
         */
         ...
         * @var int|null
         */
        public readonly ?int $refundable_amount = null,
        /**
         * @var string|null
         */
    ...
    {
        $transaction_id = Json::toString(Json::get($data, 'transaction_id'));
        $refund_id = Json::toString(Json::get($data, 'refund_id'));
        $amount = Json::toInt(Json::get($data, 'amount'));
        $currency = Json::toString(Json::get($data, 'currency'));
        $presentment_amount = Json::toInt(Json::get($data, 'presentment_amount'));
        $presentment_currency = Json::toString(Json::get($data, 'presentment_currency'));
        ...
        /** @var string|null $order_created_at */
        $order_created_at = isset($data['order_created_at']) ? Json::toString($data['order_created_at']) : null;
        ...
        /** @var int|null $refundable_amount */
        $refundable_amount = isset($data['refundable_amount']) ? Json::toInt($data['refundable_amount']) : null;
    ...
    {
        $data = [];
        $data['transaction_id'] = Json::encode($this->transaction_id);
        $data['refund_id'] = Json::encode($this->refund_id);
        $data['amount'] = Json::encode($this->amount);
        $data['currency'] = Json::encode($this->currency);
        $data['presentment_amount'] = Json::encode($this->presentment_amount);
        $data['presentment_currency'] = Json::encode($this->presentment_currency);
        $data['tax_amount'] = Json::encode($this->tax_amount);
        $data['fee'] = Json::encode($this->fee);
        if ($this->order_id !== null) {
            $data['order_id'] = Json::encode($this->order_id);
        }
        if ($this->order_created_at !== null) {
            $data['order_created_at'] = Json::encode($this->order_created_at);
        }
        ...
        if ($this->refundable_amount !== null) {
