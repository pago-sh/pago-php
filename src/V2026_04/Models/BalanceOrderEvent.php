 ...
 */
final class BalanceOrderEvent implements Model, Deserializable, SystemEvent
{
    public function __construct(
        ...
        public readonly BalanceOrderMetadata $metadata,
        /**
         * @var string|null
         */
    ...
    public static function fromArray(array $data): self
    {
        ...
        $metadata = BalanceOrderMetadata::fromArray(Json::toMap(Json::get($data, 'metadata')));
