 ...
 */
final class WebhookBenefitGrantUpdatedPayload implements Model, Deserializable, WebhookPayload
{
    ...
    public static function fromArray(array $data): self
    {
        ...
        $data = BenefitGrantWebhookFactory::fromArray(Json::toMap(Json::get($data, 'data')));
