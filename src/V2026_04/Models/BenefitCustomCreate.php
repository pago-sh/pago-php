 ...
 */
final class BenefitCustomCreate implements Model, Deserializable, BenefitCreate
{
    ...
    public static function fromArray(array $data): self
    {
        ...
        $properties = BenefitCustomCreateProperties::fromArray(Json::toMap(Json::get($data, 'properties')));
