 ...
 */
final class BenefitGrantDownloadablesWebhook implements Model, Deserializable, BenefitGrantWebhook
{
    public function __construct(
        ...
        public readonly BenefitDownloadables $benefit,
        public readonly BenefitGrantDownloadablesProperties $properties,
        /**
         * @var string|null
         */
        ...
        /**
         * @var BenefitGrantDownloadablesProperties|null
         */
        public readonly ?BenefitGrantDownloadablesProperties $previous_properties = null,
    ) {
    }
    ...
    public static function fromArray(array $data): self
    {
        ...
        $benefit = BenefitDownloadables::fromArray(Json::toMap(Json::get($data, 'benefit')));
        $properties = BenefitGrantDownloadablesProperties::fromArray(Json::toMap(Json::get($data, 'properties')));
        ...
        /** @var BenefitGrantDownloadablesProperties|null $previous_properties */
        $previous_properties = isset($data['previous_properties']) ? BenefitGrantDownloadablesProperties::fromArray(Json::toMap($data['previous_properties'])) : null;
