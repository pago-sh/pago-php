 ...
 * CustomerOrder
 */
final class CustomerOrder implements Model, Deserializable
{
    public function __construct(
        ...
        /**
         * @var CustomerOrderProduct|null
         */
        public readonly ?CustomerOrderProduct $product,
        /**
         * @var CustomerOrderSubscription|null
         */
        public readonly ?CustomerOrderSubscription $subscription,
        /**
    ...
    public static function fromArray(array $data): self
    {
        ...
        /** @var CustomerOrderProduct|null $product */
        $product = (Json::get($data, 'product') === null ? null : CustomerOrderProduct::fromArray(Json::toMap(Json::get($data, 'product'))));
        /** @var CustomerOrderSubscription|null $subscription */
        $subscription = (Json::get($data, 'subscription') === null ? null : CustomerOrderSubscription::fromArray(Json::toMap(Json::get($data, 'subscription'))));
