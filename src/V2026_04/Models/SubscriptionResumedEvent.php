 ...
 */
final class SubscriptionResumedEvent implements Model, Deserializable, SystemEvent
{
    public function __construct(
        ...
        public readonly SubscriptionResumedMetadata $metadata,
        /**
         * @var string|null
         */
    ...
    public static function fromArray(array $data): self
    {
        ...
        $metadata = SubscriptionResumedMetadata::fromArray(Json::toMap(Json::get($data, 'metadata')));
