 ...
 */
final class Checkout implements Model, Deserializable
{
    public function __construct(
         ...
         */
        public readonly array $customer_metadata,
        /**
    ...
    public static function fromArray(array $data): self
    {
        ...
        $status = CheckoutStatus::from(Json::toString(Json::get($data, 'status')));
        ...
        /** @var array<string, string|int|bool> $customer_metadata */
        $customer_metadata = Json::toMap(Json::get($data, 'customer_metadata'));
