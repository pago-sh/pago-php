 ...
 */
final class CustomFieldCreateNumber implements Model, Deserializable, CustomFieldCreate
{
    ...
    public static function fromArray(array $data): self
    {
        ...
        $properties = CustomFieldNumberProperties::fromArray(Json::toMap(Json::get($data, 'properties')));
