 ...
 */
final class SubscriptionUpdateClearedEvent implements Model, Deserializable, SystemEvent
{
    public function __construct(
        ...
        public readonly SubscriptionUpdateClearedMetadata $metadata,
        /**
         * @var string|null
         */
    ...
    public static function fromArray(array $data): self
    {
        ...
        $metadata = SubscriptionUpdateClearedMetadata::fromArray(Json::toMap(Json::get($data, 'metadata')));
