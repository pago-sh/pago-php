 ...
 */
final class BenefitDownloadablesSubscriber implements Model, Deserializable
{
    public function __construct(
        ...
        public readonly BenefitDownloadablesSubscriberProperties $properties,
    ) {
    }
    ...
    public static function fromArray(array $data): self
    {
        ...
        $properties = BenefitDownloadablesSubscriberProperties::fromArray(Json::toMap(Json::get($data, 'properties')));
