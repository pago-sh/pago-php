 ...
 */
final class LicenseKeyWithActivations implements Model, Deserializable
{
    ...
    public static function fromArray(array $data): self
    {
        ...
        /** @var list<LicenseKeyActivationBase> $activations */
        $activations = array_map(static fn (mixed $item0): LicenseKeyActivationBase => LicenseKeyActivationBase::fromArray(Json::toMap($item0)), Json::toList(Json::get($data, 'activations')));
