 ...
 * AddressInput
 */
final class AddressInput implements Model, Deserializable
{
    public function __construct(
        public readonly CountryAlpha2Input $country,
        /**
         * @var string|null
         */
    ...
    {
        $country = CountryAlpha2Input::from(Json::toString(Json::get($data, 'country')));
