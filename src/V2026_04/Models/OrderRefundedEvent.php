 ...
 */
final class OrderRefundedEvent implements Model, Deserializable, SystemEvent
{
    public function __construct(
        ...
        public readonly OrderRefundedMetadata $metadata,
        /**
         * @var string|null
         */
    ...
    public static function fromArray(array $data): self
    {
        ...
        $metadata = OrderRefundedMetadata::fromArray(Json::toMap(Json::get($data, 'metadata')));
