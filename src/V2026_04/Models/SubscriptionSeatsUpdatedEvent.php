 ...
 */
final class SubscriptionSeatsUpdatedEvent implements Model, Deserializable, SystemEvent
{
    public function __construct(
        ...
        public readonly SubscriptionSeatsUpdatedMetadata $metadata,
        /**
         * @var string|null
         */
    ...
    public static function fromArray(array $data): self
    {
        ...
        $metadata = SubscriptionSeatsUpdatedMetadata::fromArray(Json::toMap(Json::get($data, 'metadata')));
