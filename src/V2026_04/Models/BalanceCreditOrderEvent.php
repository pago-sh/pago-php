 ...
 */
final class BalanceCreditOrderEvent implements Model, Deserializable, SystemEvent
{
    public function __construct(
        ...
        public readonly BalanceCreditOrderMetadata $metadata,
        /**
         * @var string|null
         */
    ...
    public static function fromArray(array $data): self
    {
        ...
        $metadata = BalanceCreditOrderMetadata::fromArray(Json::toMap(Json::get($data, 'metadata')));
