 ...
 */
final class BenefitCustom implements Model, Deserializable, Benefit
{
    public function __construct(
        ...
        public readonly BenefitCustomProperties $properties,
    ...
    public static function fromArray(array $data): self
    {
        ...
        $properties = BenefitCustomProperties::fromArray(Json::toMap(Json::get($data, 'properties')));
