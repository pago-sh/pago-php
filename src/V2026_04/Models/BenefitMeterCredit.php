 ...
 */
final class BenefitMeterCredit implements Model, Deserializable, Benefit
{
    public function __construct(
        ...
        public readonly BenefitMeterCreditProperties $properties,
    ...
    public static function fromArray(array $data): self
    {
        ...
        $properties = BenefitMeterCreditProperties::fromArray(Json::toMap(Json::get($data, 'properties')));
