 ...
 */
final class BenefitGrantDiscordWebhook implements Model, Deserializable, BenefitGrantWebhook
{
    public function __construct(
        ...
        public readonly BenefitDiscord $benefit,
        public readonly BenefitGrantDiscordProperties $properties,
        /**
         * @var string|null
         */
        ...
        /**
         * @var BenefitGrantDiscordProperties|null
         */
        public readonly ?BenefitGrantDiscordProperties $previous_properties = null,
    ) {
    }
    ...
    public static function fromArray(array $data): self
    {
        ...
        $benefit = BenefitDiscord::fromArray(Json::toMap(Json::get($data, 'benefit')));
        $properties = BenefitGrantDiscordProperties::fromArray(Json::toMap(Json::get($data, 'properties')));
        ...
        /** @var BenefitGrantDiscordProperties|null $previous_properties */
        $previous_properties = isset($data['previous_properties']) ? BenefitGrantDiscordProperties::fromArray(Json::toMap($data['previous_properties'])) : null;
