 ...
 */
final class SubscriptionUncanceledEvent implements Model, Deserializable, SystemEvent
{
    public function __construct(
        ...
        public readonly SubscriptionUncanceledMetadata $metadata,
        /**
         * @var string|null
         */
    ...
    public static function fromArray(array $data): self
    {
        ...
        $metadata = SubscriptionUncanceledMetadata::fromArray(Json::toMap(Json::get($data, 'metadata')));
