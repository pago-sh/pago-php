 ...
 */
final class CustomFieldCreateSelect implements Model, Deserializable, CustomFieldCreate
{
    ...
    public static function fromArray(array $data): self
    {
        ...
        $properties = CustomFieldSelectProperties::fromArray(Json::toMap(Json::get($data, 'properties')));
