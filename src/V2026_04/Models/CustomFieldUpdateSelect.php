 ...
 */
final class CustomFieldUpdateSelect implements Model, Deserializable, CustomFieldUpdate
{
    public function __construct(
        ...
        /**
         * @var CustomFieldSelectProperties|null
         */
    ...
    public static function fromArray(array $data): self
    {
        ...
        /** @var CustomFieldSelectProperties|null $properties */
        $properties = isset($data['properties']) ? CustomFieldSelectProperties::fromArray(Json::toMap($data['properties'])) : null;
