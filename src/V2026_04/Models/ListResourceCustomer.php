 ...
 */
final class ListResourceCustomer implements Model, Deserializable
{
    ...
    public static function fromArray(array $data): self
    {
        ...
        $items = array_map(static fn (mixed $item0): Customer => CustomerFactory::fromArray(Json::toMap($item0)), Json::toList(Json::get($data, 'items')));
