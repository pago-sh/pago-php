 ...
 */
final class SubscriptionCanceledEvent implements Model, Deserializable, SystemEvent
{
    public function __construct(
        ...
        public readonly SubscriptionCanceledMetadata $metadata,
        /**
         * @var string|null
         */
    ...
    public static function fromArray(array $data): self
    {
        ...
        $metadata = SubscriptionCanceledMetadata::fromArray(Json::toMap(Json::get($data, 'metadata')));
