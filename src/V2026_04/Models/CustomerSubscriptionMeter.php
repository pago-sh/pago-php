 ...
 */
final class CustomerSubscriptionMeter implements Model, Deserializable
{
    public function __construct(
        ...
        public readonly CustomerSubscriptionMeterMeter $meter,
    ) {
    }
    ...
    public static function fromArray(array $data): self
    {
        ...
        $meter = CustomerSubscriptionMeterMeter::fromArray(Json::toMap(Json::get($data, 'meter')));
