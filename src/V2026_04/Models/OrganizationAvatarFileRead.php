 ...
 */
final class OrganizationAvatarFileRead implements Model, Deserializable, FileRead
{
    ...
    public static function fromArray(array $data): self
    {
        ...
        $public_url = Json::toString(Json::get($data, 'public_url'));
    ...
    public function toArray(): array
    {
        ...
        $data['public_url'] = Json::encode($this->public_url);
