 ...
 */
final class SubscriptionProductUpdatedEvent implements Model, Deserializable, SystemEvent
{
    public function __construct(
        ...
        public readonly SubscriptionProductUpdatedMetadata $metadata,
        /**
         * @var string|null
         */
    ...
    public static function fromArray(array $data): self
    {
        ...
        $metadata = SubscriptionProductUpdatedMetadata::fromArray(Json::toMap(Json::get($data, 'metadata')));
