 ...
 */
final class BenefitGrantGitHubRepositoryWebhook implements Model, Deserializable, BenefitGrantWebhook
{
    public function __construct(
        ...
        public readonly BenefitGitHubRepository $benefit,
        ...
        /**
         * @var BenefitGrantGitHubRepositoryProperties|null
         */
        public readonly ?BenefitGrantGitHubRepositoryProperties $previous_properties = null,
    ) {
    }
    ...
    public static function fromArray(array $data): self
    {
        ...
        $benefit = BenefitGitHubRepository::fromArray(Json::toMap(Json::get($data, 'benefit')));
        ...
        /** @var BenefitGrantGitHubRepositoryProperties|null $previous_properties */
        $previous_properties = isset($data['previous_properties']) ? BenefitGrantGitHubRepositoryProperties::fromArray(Json::toMap($data['previous_properties'])) : null;
