 ...
 */
final class CustomerBenefitGrantMeterCredit implements Model, Deserializable, CustomerBenefitGrant
{
    public function __construct(
        ...
        public readonly BenefitMeterCreditSubscriber $benefit,
    ...
    public static function fromArray(array $data): self
    {
        ...
        $benefit = BenefitMeterCreditSubscriber::fromArray(Json::toMap(Json::get($data, 'benefit')));
