 ...
 * Subscription
 */
final class Subscription implements Model, Deserializable
{
    ...
    public static function fromArray(array $data): self
    {
        ...
        $customer = SubscriptionCustomer::fromArray(Json::toMap(Json::get($data, 'customer')));
        $product = Product::fromArray(Json::toMap(Json::get($data, 'product')));
        ...
        /** @var list<SubscriptionMeter> $meters */
        $meters = array_map(static fn (mixed $item0): SubscriptionMeter => SubscriptionMeter::fromArray(Json::toMap($item0)), Json::toList(Json::get($data, 'meters')));
