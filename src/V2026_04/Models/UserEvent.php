 ...
 */
final class UserEvent implements Model, Deserializable, Event
{
    public function __construct(
        ...
        public readonly EventMetadataOutput $metadata,
        /**
         * @var string|null
         */
    ...
    public static function fromArray(array $data): self
    {
        ...
        $metadata = EventMetadataOutput::fromArray(Json::toMap(Json::get($data, 'metadata')));
