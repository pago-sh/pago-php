 ...
 */
final class BenefitFeatureFlagCreate implements Model, Deserializable, BenefitCreate
{
    ...
    public static function fromArray(array $data): self
    {
        ...
        $properties = BenefitFeatureFlagCreateProperties::fromArray(Json::toMap(Json::get($data, 'properties')));
