 ...
 */
final class BenefitSlackSharedChannelUpdate implements Model, Deserializable
{
    public function __construct(
        ...
        /**
         * @var BenefitSlackSharedChannelCreateProperties|null
         */
    ...
    public static function fromArray(array $data): self
    {
        ...
        /** @var BenefitSlackSharedChannelCreateProperties|null $properties */
        $properties = isset($data['properties']) ? BenefitSlackSharedChannelCreateProperties::fromArray(Json::toMap($data['properties'])) : null;
