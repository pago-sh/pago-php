 ...
 */
final class BenefitDiscordCreate implements Model, Deserializable, BenefitCreate
{
    ...
    public static function fromArray(array $data): self
    {
        ...
        $properties = BenefitDiscordCreateProperties::fromArray(Json::toMap(Json::get($data, 'properties')));
