 ...
 */
final class CheckoutCreatedEvent implements Model, Deserializable, SystemEvent
{
    public function __construct(
        ...
        public readonly CheckoutCreatedMetadata $metadata,
        /**
         * @var string|null
         */
    ...
    public static function fromArray(array $data): self
    {
        ...
        $metadata = CheckoutCreatedMetadata::fromArray(Json::toMap(Json::get($data, 'metadata')));
