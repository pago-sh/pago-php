 ...
 */
final class SubscriptionPastDueMetadata implements Model, Deserializable
{
    public function __construct(
        public readonly string $subscription_id,
        public readonly string $past_due_at,
        /**
         * @var string|null
         */
    ...
    public static function fromArray(array $data): self
    {
        ...
        $past_due_at = Json::toString(Json::get($data, 'past_due_at'));
