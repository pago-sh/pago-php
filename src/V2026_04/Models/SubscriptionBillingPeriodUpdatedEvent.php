 ...
 */
final class SubscriptionBillingPeriodUpdatedEvent implements Model, Deserializable, SystemEvent
{
    public function __construct(
        ...
        public readonly SubscriptionBillingPeriodUpdatedMetadata $metadata,
        /**
         * @var string|null
         */
    ...
    public static function fromArray(array $data): self
    {
        ...
        $metadata = SubscriptionBillingPeriodUpdatedMetadata::fromArray(Json::toMap(Json::get($data, 'metadata')));
