 ...
 */
final class WebhookCustomerStateChangedPayload implements Model, Deserializable, WebhookPayload
{
    ...
    public static function fromArray(array $data): self
    {
        ...
        $data = CustomerStateFactory::fromArray(Json::toMap(Json::get($data, 'data')));
