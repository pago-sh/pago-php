 ...
 */
final class BenefitSlackSharedChannel implements Model, Deserializable, Benefit
{
    public function __construct(
        ...
        public readonly BenefitSlackSharedChannelProperties $properties,
    ...
    public static function fromArray(array $data): self
    {
        ...
        $properties = BenefitSlackSharedChannelProperties::fromArray(Json::toMap(Json::get($data, 'properties')));
