 ...
 */
final class CustomFieldUpdateText implements Model, Deserializable, CustomFieldUpdate
{
    public function __construct(
        ...
        /**
         * @var CustomFieldTextProperties|null
         */
    ...
    public static function fromArray(array $data): self
    {
        ...
        /** @var CustomFieldTextProperties|null $properties */
        $properties = isset($data['properties']) ? CustomFieldTextProperties::fromArray(Json::toMap($data['properties'])) : null;
