 ...
 */
final class CustomerBenefitGrantFeatureFlag implements Model, Deserializable, CustomerBenefitGrant
{
    public function __construct(
        ...
        public readonly BenefitFeatureFlagSubscriber $benefit,
    ...
    public static function fromArray(array $data): self
    {
        ...
        $benefit = BenefitFeatureFlagSubscriber::fromArray(Json::toMap(Json::get($data, 'benefit')));
