 ...
 */
final class CustomerBenefitGrantDownloadables implements Model, Deserializable, CustomerBenefitGrant
{
    public function __construct(
        ...
        public readonly BenefitDownloadablesSubscriber $benefit,
    ...
    public static function fromArray(array $data): self
    {
        ...
        $benefit = BenefitDownloadablesSubscriber::fromArray(Json::toMap(Json::get($data, 'benefit')));
