 ...
 */
final class AuthorizeResponseUser implements Model, Deserializable
{
    public function __construct(
         ...
         */
        public readonly ?AuthorizeUser $sub,
        /**
         * @var list<Scope>
         */
    ...
    public static function fromArray(array $data): self
    {
        ...
        /** @var AuthorizeUser|null $sub */
        $sub = (Json::get($data, 'sub') === null ? null : AuthorizeUser::fromArray(Json::toMap(Json::get($data, 'sub'))));
