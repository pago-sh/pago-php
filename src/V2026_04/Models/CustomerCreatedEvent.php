 ...
 */
final class CustomerCreatedEvent implements Model, Deserializable, SystemEvent
{
    public function __construct(
        ...
        public readonly CustomerCreatedMetadata $metadata,
        /**
         * @var string|null
         */
    ...
    public static function fromArray(array $data): self
    {
        ...
        $metadata = CustomerCreatedMetadata::fromArray(Json::toMap(Json::get($data, 'metadata')));
