 ...
 */
final class BenefitLicenseKeysUpdate implements Model, Deserializable
{
    public function __construct(
        ...
        /**
         * @var BenefitLicenseKeysCreateProperties|null
         */
    ...
    public static function fromArray(array $data): self
    {
        ...
        /** @var BenefitLicenseKeysCreateProperties|null $properties */
        $properties = isset($data['properties']) ? BenefitLicenseKeysCreateProperties::fromArray(Json::toMap($data['properties'])) : null;
