 ...
 * BenefitCustomUpdate
 */
final class BenefitCustomUpdate implements Model, Deserializable
{
    public function __construct(
        ...
        /**
         * @var BenefitCustomProperties|null
         */
    ...
    public static function fromArray(array $data): self
    {
        ...
        /** @var BenefitCustomProperties|null $properties */
        $properties = isset($data['properties']) ? BenefitCustomProperties::fromArray(Json::toMap($data['properties'])) : null;
