 ...
 */
final class SubscriptionReactivatedEvent implements Model, Deserializable, SystemEvent
{
    public function __construct(
        ...
        public readonly SubscriptionReactivatedMetadata $metadata,
        /**
         * @var string|null
         */
    ...
    public static function fromArray(array $data): self
    {
        ...
        $metadata = SubscriptionReactivatedMetadata::fromArray(Json::toMap(Json::get($data, 'metadata')));
