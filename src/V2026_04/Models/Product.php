 ...
 * A product.
 */
final class Product implements Model, Deserializable
{
    ...
    public static function fromArray(array $data): self
    {
        ...
        /** @var list<Benefit> $benefits */
        $benefits = array_map(static fn (mixed $item0): Benefit => BenefitFactory::fromArray(Json::toMap($item0)), Json::toList(Json::get($data, 'benefits')));
        ...
        /** @var list<AttachedCustomField> $attached_custom_fields */
        $attached_custom_fields = array_map(static fn (mixed $item0): AttachedCustomField => AttachedCustomField::fromArray(Json::toMap($item0)), Json::toList(Json::get($data, 'attached_custom_fields')));
