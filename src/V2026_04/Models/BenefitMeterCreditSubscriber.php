 ...
 */
final class BenefitMeterCreditSubscriber implements Model, Deserializable
{
    public function __construct(
        ...
        public readonly BenefitMeterCreditSubscriberProperties $properties,
    ) {
    }
    ...
    public static function fromArray(array $data): self
    {
        ...
        $properties = BenefitMeterCreditSubscriberProperties::fromArray(Json::toMap(Json::get($data, 'properties')));
