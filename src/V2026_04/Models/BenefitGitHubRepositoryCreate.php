 ...
 */
final class BenefitGitHubRepositoryCreate implements Model, Deserializable, BenefitCreate
{
    ...
    public static function fromArray(array $data): self
    {
        ...
        $properties = BenefitGitHubRepositoryCreateProperties::fromArray(Json::toMap(Json::get($data, 'properties')));
