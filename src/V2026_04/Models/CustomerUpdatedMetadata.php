 ...
 */
final class CustomerUpdatedMetadata implements Model, Deserializable
{
    public function __construct(
        ...
        public readonly CustomerUpdatedFields $updated_fields,
    ) {
    }
    ...
    public static function fromArray(array $data): self
    {
        ...
        $updated_fields = CustomerUpdatedFields::fromArray(Json::toMap(Json::get($data, 'updated_fields')));
    ...
    public function toArray(): array
    {
        ...
        $data['updated_fields'] = Json::encode($this->updated_fields);
