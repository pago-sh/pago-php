 ...
 */
final class BenefitGrantLicenseKeysWebhook implements Model, Deserializable, BenefitGrantWebhook
{
    public function __construct(
        ...
        public readonly BenefitLicenseKeys $benefit,
        public readonly BenefitGrantLicenseKeysProperties $properties,
        /**
         * @var string|null
         */
        ...
        /**
         * @var BenefitGrantLicenseKeysProperties|null
         */
        public readonly ?BenefitGrantLicenseKeysProperties $previous_properties = null,
    ) {
    }
    ...
    public static function fromArray(array $data): self
    {
        ...
        $benefit = BenefitLicenseKeys::fromArray(Json::toMap(Json::get($data, 'benefit')));
        $properties = BenefitGrantLicenseKeysProperties::fromArray(Json::toMap(Json::get($data, 'properties')));
        ...
        /** @var BenefitGrantLicenseKeysProperties|null $previous_properties */
        $previous_properties = isset($data['previous_properties']) ? BenefitGrantLicenseKeysProperties::fromArray(Json::toMap($data['previous_properties'])) : null;
