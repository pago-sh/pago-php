 ...
 */
final class CustomerSubscription implements Model, Deserializable
{
    public function __construct(
        ...
        public readonly CustomerSubscriptionProduct $product,
        /**
         * @var list<LegacyRecurringProductPrice|ProductPrice>
         */
        public readonly array $prices,
        /**
         * @var list<CustomerSubscriptionMeter>
         */
        public readonly array $meters,
        /**
         * @var PendingSubscriptionUpdate|null
         */
        public readonly ?PendingSubscriptionUpdate $pending_update,
        /**
         * @var string|null
         */
    ...
    public static function fromArray(array $data): self
    {
        ...
        $product = CustomerSubscriptionProduct::fromArray(Json::toMap(Json::get($data, 'product')));
        ...
        /** @var list<CustomerSubscriptionMeter> $meters */
        $meters = array_map(static fn (mixed $item0): CustomerSubscriptionMeter => CustomerSubscriptionMeter::fromArray(Json::toMap($item0)), Json::toList(Json::get($data, 'meters')));
        /** @var PendingSubscriptionUpdate|null $pending_update */
        $pending_update = (Json::get($data, 'pending_update') === null ? null : PendingSubscriptionUpdate::fromArray(Json::toMap(Json::get($data, 'pending_update'))));
