 ...
 */
final class BenefitDiscordSubscriber implements Model, Deserializable
{
    public function __construct(
        ...
        public readonly BenefitDiscordSubscriberProperties $properties,
    ) {
    }
    ...
    public static function fromArray(array $data): self
    {
        ...
        $properties = BenefitDiscordSubscriberProperties::fromArray(Json::toMap(Json::get($data, 'properties')));
