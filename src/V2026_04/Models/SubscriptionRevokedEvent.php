 ...
 */
final class SubscriptionRevokedEvent implements Model, Deserializable, SystemEvent
{
    public function __construct(
        ...
        public readonly SubscriptionRevokedMetadata $metadata,
        /**
         * @var string|null
         */
    ...
    public static function fromArray(array $data): self
    {
        ...
        $metadata = SubscriptionRevokedMetadata::fromArray(Json::toMap(Json::get($data, 'metadata')));
