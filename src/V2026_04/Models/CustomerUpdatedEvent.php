 ...
 */
final class CustomerUpdatedEvent implements Model, Deserializable, SystemEvent
{
    public function __construct(
        ...
        public readonly CustomerUpdatedMetadata $metadata,
        /**
         * @var string|null
         */
    ...
    public static function fromArray(array $data): self
    {
        ...
        $metadata = CustomerUpdatedMetadata::fromArray(Json::toMap(Json::get($data, 'metadata')));
