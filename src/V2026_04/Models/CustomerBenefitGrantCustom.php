 ...
 */
final class CustomerBenefitGrantCustom implements Model, Deserializable, CustomerBenefitGrant
{
    public function __construct(
        ...
        public readonly BenefitCustomSubscriber $benefit,
    ...
    public static function fromArray(array $data): self
    {
        ...
        $benefit = BenefitCustomSubscriber::fromArray(Json::toMap(Json::get($data, 'benefit')));
