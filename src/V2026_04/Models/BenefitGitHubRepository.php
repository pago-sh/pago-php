 ...
 */
final class BenefitGitHubRepository implements Model, Deserializable, Benefit
{
    public function __construct(
        ...
        public readonly BenefitGitHubRepositoryProperties $properties,
    ...
    public static function fromArray(array $data): self
    {
        ...
        $properties = BenefitGitHubRepositoryProperties::fromArray(Json::toMap(Json::get($data, 'properties')));
