 ...
 */
final class BenefitRevokedEvent implements Model, Deserializable, SystemEvent
{
    public function __construct(
        ...
        public readonly BenefitGrantMetadata $metadata,
        /**
         * @var string|null
         */
    ...
    public static function fromArray(array $data): self
    {
        ...
        $metadata = BenefitGrantMetadata::fromArray(Json::toMap(Json::get($data, 'metadata')));
