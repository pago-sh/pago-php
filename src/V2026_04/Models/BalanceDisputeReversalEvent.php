 ...
 */
final class BalanceDisputeReversalEvent implements Model, Deserializable, SystemEvent
{
    public function __construct(
        ...
        public readonly BalanceDisputeMetadata $metadata,
        /**
         * @var string|null
         */
    ...
    public static function fromArray(array $data): self
    {
        ...
        $metadata = BalanceDisputeMetadata::fromArray(Json::toMap(Json::get($data, 'metadata')));
