 ...
 */
final class SubscriptionUpdatedEvent implements Model, Deserializable, SystemEvent
{
    public function __construct(
        ...
        public readonly SubscriptionUpdatedMetadata $metadata,
        /**
         * @var string|null
         */
    ...
    public static function fromArray(array $data): self
    {
        ...
        $metadata = SubscriptionUpdatedMetadata::fromArray(Json::toMap(Json::get($data, 'metadata')));
