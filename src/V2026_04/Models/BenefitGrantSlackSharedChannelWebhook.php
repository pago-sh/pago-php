 ...
 */
final class BenefitGrantSlackSharedChannelWebhook implements Model, Deserializable, BenefitGrantWebhook
{
    public function __construct(
        ...
        public readonly BenefitSlackSharedChannel $benefit,
        public readonly BenefitGrantSlackSharedChannelProperties $properties,
        /**
         * @var string|null
         */
        ...
        /**
         * @var BenefitGrantSlackSharedChannelProperties|null
         */
        public readonly ?BenefitGrantSlackSharedChannelProperties $previous_properties = null,
    ) {
    }
    ...
    public static function fromArray(array $data): self
    {
        ...
        $benefit = BenefitSlackSharedChannel::fromArray(Json::toMap(Json::get($data, 'benefit')));
        $properties = BenefitGrantSlackSharedChannelProperties::fromArray(Json::toMap(Json::get($data, 'properties')));
        ...
        /** @var BenefitGrantSlackSharedChannelProperties|null $previous_properties */
        $previous_properties = isset($data['previous_properties']) ? BenefitGrantSlackSharedChannelProperties::fromArray(Json::toMap($data['previous_properties'])) : null;
