 ...
 */
final class BenefitLicenseKeysCreate implements Model, Deserializable, BenefitCreate
{
    ...
    public static function fromArray(array $data): self
    {
        ...
        $properties = BenefitLicenseKeysCreateProperties::fromArray(Json::toMap(Json::get($data, 'properties')));
