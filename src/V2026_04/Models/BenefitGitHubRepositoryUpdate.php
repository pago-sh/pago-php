 ...
 */
final class BenefitGitHubRepositoryUpdate implements Model, Deserializable
{
    public function __construct(
        ...
        /**
         * @var BenefitGitHubRepositoryCreateProperties|null
         */
    ...
    public static function fromArray(array $data): self
    {
        ...
        /** @var BenefitGitHubRepositoryCreateProperties|null $properties */
        $properties = isset($data['properties']) ? BenefitGitHubRepositoryCreateProperties::fromArray(Json::toMap($data['properties'])) : null;
