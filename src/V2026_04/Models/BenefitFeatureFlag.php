 ...
 */
final class BenefitFeatureFlag implements Model, Deserializable, Benefit
{
    public function __construct(
        ...
        public readonly BenefitFeatureFlagProperties $properties,
    ...
    public static function fromArray(array $data): self
    {
        ...
        $properties = BenefitFeatureFlagProperties::fromArray(Json::toMap(Json::get($data, 'properties')));
