 ...
 */
final class CustomerBenefitGrantDiscord implements Model, Deserializable, CustomerBenefitGrant
{
    public function __construct(
        ...
        public readonly BenefitDiscordSubscriber $benefit,
    ...
    public static function fromArray(array $data): self
    {
        ...
        $benefit = BenefitDiscordSubscriber::fromArray(Json::toMap(Json::get($data, 'benefit')));
