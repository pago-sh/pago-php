 ...
 */
final class BenefitDownloadables implements Model, Deserializable, Benefit
{
    public function __construct(
        ...
        public readonly BenefitDownloadablesProperties $properties,
    ...
    public static function fromArray(array $data): self
    {
        ...
        $properties = BenefitDownloadablesProperties::fromArray(Json::toMap(Json::get($data, 'properties')));
