 ...
 */
final class BalanceRefundReversalEvent implements Model, Deserializable, SystemEvent
{
    public function __construct(
        ...
        public readonly BalanceRefundMetadata $metadata,
        /**
         * @var string|null
         */
    ...
    public static function fromArray(array $data): self
    {
        ...
        $metadata = BalanceRefundMetadata::fromArray(Json::toMap(Json::get($data, 'metadata')));
