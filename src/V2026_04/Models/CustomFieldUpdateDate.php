 ...
 */
final class CustomFieldUpdateDate implements Model, Deserializable, CustomFieldUpdate
{
    public function __construct(
        ...
        /**
         * @var CustomFieldDateProperties|null
         */
    ...
    public static function fromArray(array $data): self
    {
        ...
        /** @var CustomFieldDateProperties|null $properties */
        $properties = isset($data['properties']) ? CustomFieldDateProperties::fromArray(Json::toMap($data['properties'])) : null;
