 ...
 */
final class BenefitFeatureFlagUpdate implements Model, Deserializable
{
    public function __construct(
        ...
        /**
         * @var BenefitFeatureFlagProperties|null
         */
    ...
    public static function fromArray(array $data): self
    {
        ...
        /** @var BenefitFeatureFlagProperties|null $properties */
        $properties = isset($data['properties']) ? BenefitFeatureFlagProperties::fromArray(Json::toMap($data['properties'])) : null;
