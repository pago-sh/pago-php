 ...
 */
final class CustomerBenefitGrantLicenseKeys implements Model, Deserializable, CustomerBenefitGrant
{
    public function __construct(
        ...
        public readonly BenefitLicenseKeysSubscriber $benefit,
    ...
    public static function fromArray(array $data): self
    {
        ...
        $benefit = BenefitLicenseKeysSubscriber::fromArray(Json::toMap(Json::get($data, 'benefit')));
