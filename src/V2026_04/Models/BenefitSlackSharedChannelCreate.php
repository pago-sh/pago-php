 ...
 */
final class BenefitSlackSharedChannelCreate implements Model, Deserializable, BenefitCreate
{
    ...
    public static function fromArray(array $data): self
    {
        ...
        $properties = BenefitSlackSharedChannelCreateProperties::fromArray(Json::toMap(Json::get($data, 'properties')));
