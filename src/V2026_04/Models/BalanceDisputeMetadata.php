 ...
 */
final class BalanceDisputeMetadata implements Model, Deserializable
{
    ...
    public static function fromArray(array $data): self
    {
        ...
        $dispute_id = Json::toString(Json::get($data, 'dispute_id'));
    ...
    public function toArray(): array
    {
        ...
        $data['dispute_id'] = Json::encode($this->dispute_id);
