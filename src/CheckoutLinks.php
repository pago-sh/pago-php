...
class CheckoutLinks
{
     ...
     *
     * @param  \Pago\Models\Components\CheckoutLinkCreateProductPrice|\Pago\Models\Components\CheckoutLinkCreateProduct|\Pago\Models\Components\CheckoutLinkCreateProducts  $request
     * @return \Pago\Models\Operations\CheckoutLinksCreateResponse
    ...
    public function create(Components\CheckoutLinkCreateProductPrice|Components\CheckoutLinkCreateProduct|Components\CheckoutLinkCreateProducts $request, ?Options $options = null): Operations\CheckoutLinksCreateResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['201'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $obj = $serializer->deserialize($responseData, '\Pago\Models\Components\CheckoutLink', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
     ...
     *
     * @param  string  $id
     * @return \Pago\Models\Operations\CheckoutLinksDeleteResponse
     * @throws \Pago\Models\Errors\APIException
     */
     ...
     *
     * @param  string  $id
     * @return \Pago\Models\Operations\CheckoutLinksGetResponse
     * @throws \Pago\Models\Errors\APIException
     */
     ...
     * **Scopes**: `checkout_links:read` `checkout_links:write`
     *
     * @param  ?\Pago\Models\Operations\CheckoutLinksListRequest  $request
     * @return \Pago\Models\Operations\CheckoutLinksListResponse
     * @throws \Pago\Models\Errors\APIException
     */
    private function listIndividual(?Operations\CheckoutLinksListRequest $request = null, ?Options $options = null): Operations\CheckoutLinksListResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\Pago\Models\Components\ListResourceCheckoutLink', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
     ...
     *
     * @param  ?\Pago\Models\Operations\CheckoutLinksListRequest  $request
     * @return \Generator<\Pago\Models\Operations\CheckoutLinksListResponse>
     * @throws \Pago\Models\Errors\APIException
     */
     ...
     * **Scopes**: `checkout_links:write`
     *
     * @param  \Pago\Models\Components\CheckoutLinkUpdate  $checkoutLinkUpdate
     * @param  string  $id
     * @return \Pago\Models\Operations\CheckoutLinksUpdateResponse
     * @throws \Pago\Models\Errors\APIException
     */
