...
class CustomerSession
{
     ...
     *
     * @param  \Pago\Models\Operations\CustomerPortalCustomerSessionGetAuthenticatedUserSecurity  $security
     * @return \Pago\Models\Operations\CustomerPortalCustomerSessionGetAuthenticatedUserResponse
    ...
    public function getAuthenticatedUser(Operations\CustomerPortalCustomerSessionGetAuthenticatedUserSecurity $security, ?Options $options = null): Operations\CustomerPortalCustomerSessionGetAuthenticatedUserResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $obj = $serializer->deserialize($responseData, '\Pago\Models\Components\PortalAuthenticatedUser', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
     ...
     * **Scopes**: `customer_portal:read` `customer_portal:write`
     *
     * @param  \Pago\Models\Operations\CustomerPortalCustomerSessionIntrospectSecurity  $security
     * @return \Pago\Models\Operations\CustomerPortalCustomerSessionIntrospectResponse
     * @throws \Pago\Models\Errors\APIException
     */
    public function introspect(Operations\CustomerPortalCustomerSessionIntrospectSecurity $security, ?Options $options = null): Operations\CustomerPortalCustomerSessionIntrospectResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\Pago\Models\Components\CustomerCustomerSession', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
