...
class Metrics
{
     ...
     *
     * @param  \Pago\Models\Components\MetricDashboardCreate  $request
     * @return \Pago\Models\Operations\MetricsCreateDashboardResponse
    ...
    public function createDashboard(Components\MetricDashboardCreate $request, ?Options $options = null): Operations\MetricsCreateDashboardResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['201'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $obj = $serializer->deserialize($responseData, '\Pago\Models\Components\MetricDashboardSchema', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
     ...
     *
     * @param  string  $id
     * @return \Pago\Models\Operations\MetricsDeleteDashboardResponse
     * @throws \Pago\Models\Errors\APIException
     */
     ...
     * **Scopes**: `metrics:read`
     *
     * @param  \Pago\Models\Operations\MetricsGetRequest  $request
     * @return \Pago\Models\Operations\MetricsGetResponse
     * @throws \Pago\Models\Errors\APIException
     */
    public function get(Operations\MetricsGetRequest $request, ?Options $options = null): Operations\MetricsGetResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\Pago\Models\Components\MetricsResponse', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
     ...
     *
     * @param  string  $id
     * @return \Pago\Models\Operations\MetricsGetDashboardResponse
     * @throws \Pago\Models\Errors\APIException
     */
     ...
     * **Scopes**: `metrics:read`
     *
     * @return \Pago\Models\Operations\MetricsLimitsResponse
     * @throws \Pago\Models\Errors\APIException
     */
    public function limits(?Options $options = null): Operations\MetricsLimitsResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\Pago\Models\Components\MetricsLimits', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
     ...
     * @return \Pago\Models\Operations\MetricsListDashboardsResponse
     * @throws \Pago\Models\Errors\APIException
     */
    public function listDashboards(string|array|null $organizationId = null, ?Options $options = null): Operations\MetricsListDashboardsResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, 'array<\Pago\Models\Components\MetricDashboardSchema>', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
     ...
     * @param  string  $id
     * @return \Pago\Models\Operations\MetricsUpdateDashboardResponse
     * @throws \Pago\Models\Errors\APIException
     */
