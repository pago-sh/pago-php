...
class Files
{
     ...
     * **Scopes**: `files:write`
     *
     * @param  \Pago\Models\Components\DownloadableFileCreate|\Pago\Models\Components\ProductMediaFileCreate|\Pago\Models\Components\OrganizationAvatarFileCreate  $request
     * @return \Pago\Models\Operations\FilesCreateResponse
    ...
    public function create(Components\DownloadableFileCreate|Components\ProductMediaFileCreate|Components\OrganizationAvatarFileCreate $request, ?Options $options = null): Operations\FilesCreateResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['201'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $obj = $serializer->deserialize($responseData, '\Pago\Models\Components\FileUpload', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
     ...
     *
     * @param  string  $id
     * @return \Pago\Models\Operations\FilesDeleteResponse
     * @throws \Pago\Models\Errors\APIException
     */
     ...
     * @param  ?int  $page
     * @param  ?int  $limit
     * @return \Pago\Models\Operations\FilesListResponse
     * @throws \Pago\Models\Errors\APIException
     */
    private function listIndividual(string|array|null $organizationId = null, string|array|null $ids = null, ?int $page = null, ?int $limit = null, ?Options $options = null): Operations\FilesListResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\Pago\Models\Components\ListResourceFileRead', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
     ...
     * @param  ?int  $page
     * @param  ?int  $limit
     * @return \Generator<\Pago\Models\Operations\FilesListResponse>
     * @throws \Pago\Models\Errors\APIException
     */
     ...
     * @param  string  $id
     * @return \Pago\Models\Operations\FilesUpdateResponse
     * @throws \Pago\Models\Errors\APIException
     */
    public function update(Components\FilePatch $filePatch, string $id, ?Options $options = null): Operations\FilesUpdateResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\Pago\Models\Components\DownloadableFileRead|\Pago\Models\Components\ProductMediaFileRead|\Pago\Models\Components\OrganizationAvatarFileRead', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
     ...
     * **Scopes**: `files:write`
     *
     * @param  \Pago\Models\Components\FileUploadCompleted  $fileUploadCompleted
     * @param  string  $id
     * @return \Pago\Models\Operations\FilesUploadedResponse
     * @throws \Pago\Models\Errors\APIException
     */
