...
class PagoBenefitGrants
{
     ...
     *
     * @param  \Pago\Models\Operations\CustomerPortalBenefitGrantsGetSecurity  $security
     * @param  string  $id
     * @return \Pago\Models\Operations\CustomerPortalBenefitGrantsGetResponse
    ...
    public function get(Operations\CustomerPortalBenefitGrantsGetSecurity $security, string $id, ?Options $options = null): Operations\CustomerPortalBenefitGrantsGetResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $obj = $serializer->deserialize($responseData, '\Pago\Models\Components\CustomerBenefitGrantDiscord|\Pago\Models\Components\CustomerBenefitGrantGitHubRepository|\Pago\Models\Components\CustomerBenefitGrantDownloadables|\Pago\Models\Components\CustomerBenefitGrantLicenseKeys|\Pago\Models\Components\CustomerBenefitGrantCustom|\Pago\Models\Components\CustomerBenefitGrantMeterCredit|\Pago\Models\Components\CustomerBenefitGrantFeatureFlag', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
     ...
     * **Scopes**: `customer_portal:read` `customer_portal:write`
     *
     * @param  \Pago\Models\Operations\CustomerPortalBenefitGrantsListSecurity  $security
     * @param  ?\Pago\Models\Operations\CustomerPortalBenefitGrantsListRequest  $request
     * @return \Pago\Models\Operations\CustomerPortalBenefitGrantsListResponse
     * @throws \Pago\Models\Errors\APIException
     */
    private function listIndividual(Operations\CustomerPortalBenefitGrantsListSecurity $security, ?Operations\CustomerPortalBenefitGrantsListRequest $request = null, ?Options $options = null): Operations\CustomerPortalBenefitGrantsListResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\Pago\Models\Components\ListResourceCustomerBenefitGrant', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
     ...
     * @param  \Pago\Models\Operations\CustomerPortalBenefitGrantsListSecurity  $security
     * @param  ?\Pago\Models\Operations\CustomerPortalBenefitGrantsListRequest  $request
     * @return \Generator<\Pago\Models\Operations\CustomerPortalBenefitGrantsListResponse>
     * @throws \Pago\Models\Errors\APIException
     */
     ...
     *
     * @param  \Pago\Models\Operations\CustomerPortalBenefitGrantsUpdateSecurity  $security
     ...
     * @param  string  $id
     * @return \Pago\Models\Operations\CustomerPortalBenefitGrantsUpdateResponse
     * @throws \Pago\Models\Errors\APIException
     */
