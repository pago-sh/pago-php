...
class Downloadables
{
     ...
     *
     * @param  \Pago\Models\Operations\CustomerPortalDownloadablesListSecurity  $security
     * @param  string|array<string>|null  $benefitId
     * @param  ?int  $page
     * @param  ?int  $limit
     * @return \Pago\Models\Operations\CustomerPortalDownloadablesListResponse
    ...
    private function listIndividual(Operations\CustomerPortalDownloadablesListSecurity $security, string|array|null $benefitId = null, ?int $page = null, ?int $limit = null, ?Options $options = null): Operations\CustomerPortalDownloadablesListResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $obj = $serializer->deserialize($responseData, '\Pago\Models\Components\ListResourceDownloadableRead', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
     ...
     * @param  ?int  $page
     * @param  ?int  $limit
     * @return \Generator<\Pago\Models\Operations\CustomerPortalDownloadablesListResponse>
     * @throws \Pago\Models\Errors\APIException
     */
