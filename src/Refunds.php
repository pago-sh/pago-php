...
class Refunds
{
     ...
     *
     * @param  \Pago\Models\Components\RefundCreate  $request
     * @return \Pago\Models\Operations\RefundsCreateResponse
    ...
    public function create(Components\RefundCreate $request, ?Options $options = null): Operations\RefundsCreateResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['201'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $obj = $serializer->deserialize($responseData, '\Pago\Models\Components\Refund', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
            ...
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\Pago\Models\Errors\RefundedAlready', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
     ...
     *
     * @param  ?\Pago\Models\Operations\RefundsListRequest  $request
     * @return \Pago\Models\Operations\RefundsListResponse
     * @throws \Pago\Models\Errors\APIException
     */
    private function listIndividual(?Operations\RefundsListRequest $request = null, ?Options $options = null): Operations\RefundsListResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\Pago\Models\Components\ListResourceRefund', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
     ...
     *
     * @param  ?\Pago\Models\Operations\RefundsListRequest  $request
     * @return \Generator<\Pago\Models\Operations\RefundsListResponse>
     * @throws \Pago\Models\Errors\APIException
     */
