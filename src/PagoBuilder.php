...
use Pago\Utils\Retry;

/**
 * PagoBuilder is used to configure and build an instance of the SDK.
 */
class PagoBuilder
{
     ...
     * @return PagoBuilder
     */
    public function setClient(\GuzzleHttp\ClientInterface $client): PagoBuilder
    {
     ...
     * @return PagoBuilder
     */
    public function setSecurity(string $accessToken): PagoBuilder
    {
     ...
     * @return PagoBuilder
     */
    public function setSecuritySource(\Closure $securitySource): PagoBuilder
    {
     ...
     * @return PagoBuilder
     */
    public function setServerUrl(string $serverUrl, ?array $params = null): PagoBuilder
    {
     ...
     * @return PagoBuilder
     */
    public function setServer(string $server): PagoBuilder
    {
    ...
    public function setRetryConfig(Retry\RetryConfig $config): PagoBuilder
    {
    ...
    public function build(): Pago
    {
        ...
        return new Pago($this->sdkConfig);
    }
}