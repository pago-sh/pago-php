...
/**
 * Pago - Pago API: Pago HTTP and Webhooks API
 *
...
class Pago
{
    ...
    public const SERVERS = [
        ...
        Pago::SERVER_PRODUCTION => 'https://api.pago.sh',
        /** Sandbox environment */
        Pago::SERVER_SANDBOX => 'https://sandbox-api.pago.sh',
    ];
     ...
     * @return PagoBuilder
     */
    public static function builder(): PagoBuilder
    {
