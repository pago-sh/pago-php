...
class ProductMediaFileCreate
{
    ...
    /**
     *
     * @var \Pago\Models\Components\S3FileCreateMultipart $upload
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('upload')]
    #[\Speakeasy\Serializer\Annotation\Type('\Pago\Models\Components\S3FileCreateMultipart')]
     ...
     * @param  int  $size
     * @param  \Pago\Models\Components\S3FileCreateMultipart  $upload
