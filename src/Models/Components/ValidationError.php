...
class ValidationError
{
    ...
    /**
     *
     * @var ?\Pago\Models\Components\Context $ctx
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('ctx')]
    #[\Speakeasy\Serializer\Annotation\Type('\Pago\Models\Components\Context|null')]
    #[\Speakeasy\Serializer\Annotation\SkipWhenNull]
     ...
     * @param  string  $type
     * @param  mixed  $input
     * @param  ?\Pago\Models\Components\Context  $ctx
     * @phpstan-pure
     */
