...
class MetricsIntervalsLimits
{
     ...
     *
     * @var \Pago\Models\Components\MetricsIntervalLimit $hour
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('hour')]
    #[\Speakeasy\Serializer\Annotation\Type('\Pago\Models\Components\MetricsIntervalLimit')]
    public MetricsIntervalLimit $hour;

    /**
     * Date interval limit to get metrics for a given interval.
     *
     * @var \Pago\Models\Components\MetricsIntervalLimit $day
     */
     ...
     * Date interval limit to get metrics for a given interval.
     *
     * @var \Pago\Models\Components\MetricsIntervalLimit $week
     */
     ...
     * Date interval limit to get metrics for a given interval.
     *
     * @var \Pago\Models\Components\MetricsIntervalLimit $month
     */
     ...
     * Date interval limit to get metrics for a given interval.
     *
     * @var \Pago\Models\Components\MetricsIntervalLimit $year
     */
    ...
    /**
     * @param  \Pago\Models\Components\MetricsIntervalLimit  $hour
     * @param  \Pago\Models\Components\MetricsIntervalLimit  $day
     * @param  \Pago\Models\Components\MetricsIntervalLimit  $week
     * @param  \Pago\Models\Components\MetricsIntervalLimit  $month
     * @param  \Pago\Models\Components\MetricsIntervalLimit  $year
     * @phpstan-pure
     */
