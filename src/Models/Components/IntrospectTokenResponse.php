...
class IntrospectTokenResponse
{
    ...
    /**
     *
     * @var \Pago\Models\Components\TokenType $tokenType
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('token_type')]
    #[\Speakeasy\Serializer\Annotation\Type('\Pago\Models\Components\TokenType')]
    ...
    /**
     *
     * @var \Pago\Models\Components\SubType $subType
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('sub_type')]
    #[\Speakeasy\Serializer\Annotation\Type('\Pago\Models\Components\SubType')]
     ...
     * @param  \Pago\Models\Components\TokenType  $tokenType
     * @param  string  $scope
     * @param  \Pago\Models\Components\SubType  $subType
     * @param  string  $sub
     * @param  string  $aud
     * @param  string  $iss
     * @param  int  $exp
