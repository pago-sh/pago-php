...
class BenefitGitHubRepositoryProperties
{
     ...
     *
     * @var \Pago\Models\Components\Permission $permission
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('permission')]
    #[\Speakeasy\Serializer\Annotation\Type('\Pago\Models\Components\Permission')]
    public Permission $permission;

    /**
     * @param  string  $repositoryOwner
     * @param  string  $repositoryName
     * @param  \Pago\Models\Components\Permission  $permission
     * @phpstan-pure
     */
