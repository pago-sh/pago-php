...
class RefundDispute
{
    ...
    /**
     *
     * @var \Pago\Models\Components\DisputeStatus $status
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('status')]
    #[\Speakeasy\Serializer\Annotation\Type('\Pago\Models\Components\DisputeStatus')]
     ...
     * @param  string  $id
     * @param  \Pago\Models\Components\DisputeStatus  $status
     * @param  bool  $resolved
     * @param  bool  $closed
     * @param  int  $amount
     * @param  int  $taxAmount
