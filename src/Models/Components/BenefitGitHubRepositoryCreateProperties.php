...
class BenefitGitHubRepositoryCreateProperties
{
     ...
     *
     * @var \Pago\Models\Components\BenefitGitHubRepositoryCreatePropertiesPermission $permission
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('permission')]
    #[\Speakeasy\Serializer\Annotation\Type('\Pago\Models\Components\BenefitGitHubRepositoryCreatePropertiesPermission')]
    public BenefitGitHubRepositoryCreatePropertiesPermission $permission;

    /**
     * @param  string  $repositoryOwner
     * @param  string  $repositoryName
     * @param  \Pago\Models\Components\BenefitGitHubRepositoryCreatePropertiesPermission  $permission
     * @phpstan-pure
     */
