...
class FileUpload
{
    ...
    /**
     *
     * @var \Pago\Models\Components\S3FileUploadMultipart $upload
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('upload')]
    #[\Speakeasy\Serializer\Annotation\Type('\Pago\Models\Components\S3FileUploadMultipart')]
    public S3FileUploadMultipart $upload;

    /**
     *
     * @var \Pago\Models\Components\FileServiceTypes $service
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('service')]
    #[\Speakeasy\Serializer\Annotation\Type('\Pago\Models\Components\FileServiceTypes')]
     ...
     * @param  int  $size
     * @param  \Pago\Models\Components\S3FileUploadMultipart  $upload
     * @param  \Pago\Models\Components\FileServiceTypes  $service
