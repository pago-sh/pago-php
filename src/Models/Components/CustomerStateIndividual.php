...
class CustomerStateIndividual
{
     ...
     *
     * @var array<\Pago\Models\Components\CustomerStateSubscription> $activeSubscriptions
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('active_subscriptions')]
    #[\Speakeasy\Serializer\Annotation\Type('array<\Pago\Models\Components\CustomerStateSubscription>')]
    public array $activeSubscriptions;

    /**
     * The customer's active benefit grants.
     *
     * @var array<\Pago\Models\Components\CustomerStateBenefitGrant> $grantedBenefits
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('granted_benefits')]
    #[\Speakeasy\Serializer\Annotation\Type('array<\Pago\Models\Components\CustomerStateBenefitGrant>')]
    public array $grantedBenefits;

    /**
     * The customer's active meters.
     *
     * @var array<\Pago\Models\Components\CustomerStateMeter> $activeMeters
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('active_meters')]
    #[\Speakeasy\Serializer\Annotation\Type('array<\Pago\Models\Components\CustomerStateMeter>')]
     ...
     * $taxId
     *
     * @var ?array<string|\Pago\Models\Components\TaxIDFormat|null> $taxId
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('tax_id')]
    #[\Speakeasy\Serializer\Annotation\Type('array<string|\Pago\Models\Components\TaxIDFormat|null>|null')]
    public ?array $taxId;
     ...
     * @param  array<\Pago\Models\Components\CustomerStateSubscription>  $activeSubscriptions
     * @param  array<\Pago\Models\Components\CustomerStateBenefitGrant>  $grantedBenefits
     * @param  array<\Pago\Models\Components\CustomerStateMeter>  $activeMeters
     * @param  string  $avatarUrl
     * @param  ?\DateTime  $modifiedAt
     * @param  ?string  $name
     * @param  ?\Pago\Models\Components\Address  $billingAddress
     * @param  ?array<string|\Pago\Models\Components\TaxIDFormat|null>  $taxId
