...
class FileDownload
{
    ...
    /**
     *
     * @var \Pago\Models\Components\S3DownloadURL $download
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('download')]
    #[\Speakeasy\Serializer\Annotation\Type('\Pago\Models\Components\S3DownloadURL')]
     ...
     * @param  int  $size
     * @param  \Pago\Models\Components\S3DownloadURL  $download
