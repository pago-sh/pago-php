...
class CustomerUpdatedFields
{
    ...
    /**
     *
     * @var ?\Pago\Models\Components\AddressDict $billingAddress
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('billing_address')]
    #[\Speakeasy\Serializer\Annotation\Type('\Pago\Models\Components\AddressDict|null')]
    #[\Speakeasy\Serializer\Annotation\SkipWhenNull]
     ...
     * @param  ?string  $name
     * @param  ?string  $email
     * @param  ?\Pago\Models\Components\AddressDict  $billingAddress
     * @param  ?string  $taxId
