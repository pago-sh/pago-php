...
class OAuth2ClientConfigurationUpdate
{
     ...
     * $grantTypes
     *
     * @var ?array<\Pago\Models\Components\OAuth2ClientConfigurationUpdateGrantTypes> $grantTypes
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('grant_types')]
    #[\Speakeasy\Serializer\Annotation\Type('array<\Pago\Models\Components\OAuth2ClientConfigurationUpdateGrantTypes>|null')]
    ...
    /**
     *
     * @var ?\Pago\Models\Components\SubType $defaultSubType
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('default_sub_type')]
    #[\Speakeasy\Serializer\Annotation\Type('\Pago\Models\Components\SubType|null')]
    #[\Speakeasy\Serializer\Annotation\SkipWhenNull]
    ...
    /**
     *
     * @var ?\Pago\Models\Components\OAuth2ClientConfigurationUpdateTokenEndpointAuthMethod $tokenEndpointAuthMethod
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('token_endpoint_auth_method')]
    #[\Speakeasy\Serializer\Annotation\Type('\Pago\Models\Components\OAuth2ClientConfigurationUpdateTokenEndpointAuthMethod|null')]
    #[\Speakeasy\Serializer\Annotation\SkipWhenNull]
     ...
     * @param  ?\Pago\Models\Components\OAuth2ClientConfigurationUpdateTokenEndpointAuthMethod  $tokenEndpointAuthMethod
     * @param  ?array<\Pago\Models\Components\OAuth2ClientConfigurationUpdateGrantTypes>  $grantTypes
     * @param  ?array<string>  $responseTypes
     * @param  ?string  $scope
     * @param  ?\Pago\Models\Components\SubType  $defaultSubType
