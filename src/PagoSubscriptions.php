...
class PagoSubscriptions
{
     ...
     *
     * @param  \Pago\Models\Operations\CustomerPortalSubscriptionsCancelSecurity  $security
     * @param  string  $id
     * @return \Pago\Models\Operations\CustomerPortalSubscriptionsCancelResponse
    ...
    public function cancel(Operations\CustomerPortalSubscriptionsCancelSecurity $security, string $id, ?Options $options = null): Operations\CustomerPortalSubscriptionsCancelResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $obj = $serializer->deserialize($responseData, '\Pago\Models\Components\CustomerSubscription', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
     ...
     *
     * @param  \Pago\Models\Operations\CustomerPortalSubscriptionsGetSecurity  $security
     * @param  string  $id
     * @return \Pago\Models\Operations\CustomerPortalSubscriptionsGetResponse
     * @throws \Pago\Models\Errors\APIException
     */
     ...
     * **Scopes**: `customer_portal:read` `customer_portal:write`
     *
     * @param  \Pago\Models\Operations\CustomerPortalSubscriptionsListSecurity  $security
     * @param  ?\Pago\Models\Operations\CustomerPortalSubscriptionsListRequest  $request
     * @return \Pago\Models\Operations\CustomerPortalSubscriptionsListResponse
     * @throws \Pago\Models\Errors\APIException
     */
    private function listIndividual(Operations\CustomerPortalSubscriptionsListSecurity $security, ?Operations\CustomerPortalSubscriptionsListRequest $request = null, ?Options $options = null): Operations\CustomerPortalSubscriptionsListResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\Pago\Models\Components\ListResourceCustomerSubscription', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
     ...
     * @param  \Pago\Models\Operations\CustomerPortalSubscriptionsListSecurity  $security
     * @param  ?\Pago\Models\Operations\CustomerPortalSubscriptionsListRequest  $request
     * @return \Generator<\Pago\Models\Operations\CustomerPortalSubscriptionsListResponse>
     * @throws \Pago\Models\Errors\APIException
     */
     ...
     *
     * @param  \Pago\Models\Operations\CustomerPortalSubscriptionsUpdateSecurity  $security
     ...
     * @param  string  $id
     * @return \Pago\Models\Operations\CustomerPortalSubscriptionsUpdateResponse
     * @throws \Pago\Models\Errors\APIException
     */
