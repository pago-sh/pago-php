...
class PagoMembers
{
     ...
     *
     * @param  \Pago\Models\Components\CustomerPortalMemberCreate  $request
     * @return \Pago\Models\Operations\CustomerPortalMembersAddMemberResponse
    ...
    public function addMember(Components\CustomerPortalMemberCreate $request, ?Options $options = null): Operations\CustomerPortalMembersAddMemberResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['201'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $obj = $serializer->deserialize($responseData, '\Pago\Models\Components\CustomerPortalMember', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
     ...
     * @param  ?int  $page
     * @param  ?int  $limit
     * @return \Pago\Models\Operations\CustomerPortalMembersListMembersResponse
     * @throws \Pago\Models\Errors\APIException
     */
    private function listMembersIndividual(?int $page = null, ?int $limit = null, ?Options $options = null): Operations\CustomerPortalMembersListMembersResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\Pago\Models\Components\ListResourceCustomerPortalMember', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
     ...
     * @param  ?int  $page
     * @param  ?int  $limit
     * @return \Generator<\Pago\Models\Operations\CustomerPortalMembersListMembersResponse>
     * @throws \Pago\Models\Errors\APIException
     */
     ...
     *
     * @param  string  $id
     * @return \Pago\Models\Operations\CustomerPortalMembersRemoveMemberResponse
     * @throws \Pago\Models\Errors\APIException
     */
     ...
     * @param  string  $id
     * @return \Pago\Models\Operations\CustomerPortalMembersUpdateMemberResponse
     * @throws \Pago\Models\Errors\APIException
     */
