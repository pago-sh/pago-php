...
class Benefits
{
     ...
     *
     * @param  \Pago\Models\Components\BenefitCustomCreate|\Pago\Models\Components\BenefitDiscordCreate|\Pago\Models\Components\BenefitGitHubRepositoryCreate|\Pago\Models\Components\BenefitDownloadablesCreate|\Pago\Models\Components\BenefitLicenseKeysCreate|\Pago\Models\Components\BenefitMeterCreditCreate|\Pago\Models\Components\BenefitFeatureFlagCreate  $request
     * @return \Pago\Models\Operations\BenefitsCreateResponse
    ...
    public function create(Components\BenefitCustomCreate|Components\BenefitDiscordCreate|Components\BenefitGitHubRepositoryCreate|Components\BenefitDownloadablesCreate|Components\BenefitLicenseKeysCreate|Components\BenefitMeterCreditCreate|Components\BenefitFeatureFlagCreate $request, ?Options $options = null): Operations\BenefitsCreateResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['201'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $obj = $serializer->deserialize($responseData, '\Pago\Models\Components\BenefitCustom|\Pago\Models\Components\BenefitDiscord|\Pago\Models\Components\BenefitGitHubRepository|\Pago\Models\Components\BenefitDownloadables|\Pago\Models\Components\BenefitLicenseKeys|\Pago\Models\Components\BenefitMeterCredit|\Pago\Models\Components\BenefitFeatureFlag', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
     ...
     *
     * @param  string  $id
     * @return \Pago\Models\Operations\BenefitsDeleteResponse
     * @throws \Pago\Models\Errors\APIException
     */
    public function delete(string $id, ?Options $options = null): Operations\BenefitsDeleteResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['204'])) {
            ...
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\Pago\Models\Errors\NotPermitted', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
                throw $obj->toException();
            } else {
                throw new \Pago\Models\Errors\APIException('Unknown content type received', $statusCode, $httpResponse->getBody()->getContents(), $httpResponse);
            }
     ...
     *
     * @param  string  $id
     * @return \Pago\Models\Operations\BenefitsGetResponse
     * @throws \Pago\Models\Errors\APIException
     */
     ...
     * **Scopes**: `benefits:read` `benefits:write`
     *
     * @param  \Pago\Models\Operations\BenefitsGrantsRequest  $request
     * @return \Pago\Models\Operations\BenefitsGrantsResponse
     * @throws \Pago\Models\Errors\APIException
     */
    private function grantsIndividual(Operations\BenefitsGrantsRequest $request, ?Options $options = null): Operations\BenefitsGrantsResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\Pago\Models\Components\ListResourceBenefitGrant', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
     ...
     *
     * @param  \Pago\Models\Operations\BenefitsGrantsRequest  $request
     * @return \Generator<\Pago\Models\Operations\BenefitsGrantsResponse>
     * @throws \Pago\Models\Errors\APIException
     */
     ...
     * **Scopes**: `benefits:read` `benefits:write`
     *
     * @param  ?\Pago\Models\Operations\BenefitsListRequest  $request
     * @return \Pago\Models\Operations\BenefitsListResponse
     * @throws \Pago\Models\Errors\APIException
     */
    private function listIndividual(?Operations\BenefitsListRequest $request = null, ?Options $options = null): Operations\BenefitsListResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\Pago\Models\Components\ListResourceBenefit', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
     ...
     *
     * @param  ?\Pago\Models\Operations\BenefitsListRequest  $request
     * @return \Generator<\Pago\Models\Operations\BenefitsListResponse>
     * @throws \Pago\Models\Errors\APIException
     */
     ...
     * @param  string  $id
     * @return \Pago\Models\Operations\BenefitsUpdateResponse
     * @throws \Pago\Models\Errors\APIException
     */
