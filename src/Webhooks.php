...
class Webhooks
{
     ...
     *
     * @param  \Pago\Models\Components\WebhookEndpointCreate  $request
     * @return \Pago\Models\Operations\WebhooksCreateWebhookEndpointResponse
    ...
    public function createWebhookEndpoint(Components\WebhookEndpointCreate $request, ?Options $options = null): Operations\WebhooksCreateWebhookEndpointResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['201'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $obj = $serializer->deserialize($responseData, '\Pago\Models\Components\WebhookEndpoint', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
     ...
     *
     * @param  string  $id
     * @return \Pago\Models\Operations\WebhooksDeleteWebhookEndpointResponse
     * @throws \Pago\Models\Errors\APIException
     */
     ...
     *
     * @param  string  $id
     * @return \Pago\Models\Operations\WebhooksGetWebhookEndpointResponse
     * @throws \Pago\Models\Errors\APIException
     */
     ...
     * **Scopes**: `webhooks:read` `webhooks:write`
     *
     * @param  ?\Pago\Models\Operations\WebhooksListWebhookDeliveriesRequest  $request
     * @return \Pago\Models\Operations\WebhooksListWebhookDeliveriesResponse
     * @throws \Pago\Models\Errors\APIException
     */
    private function listWebhookDeliveriesIndividual(?Operations\WebhooksListWebhookDeliveriesRequest $request = null, ?Options $options = null): Operations\WebhooksListWebhookDeliveriesResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\Pago\Models\Components\ListResourceWebhookDelivery', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
     ...
     *
     * @param  ?\Pago\Models\Operations\WebhooksListWebhookDeliveriesRequest  $request
     * @return \Generator<\Pago\Models\Operations\WebhooksListWebhookDeliveriesResponse>
     * @throws \Pago\Models\Errors\APIException
     */
     ...
     * @param  ?int  $page
     * @param  ?int  $limit
     * @return \Pago\Models\Operations\WebhooksListWebhookEndpointsResponse
     * @throws \Pago\Models\Errors\APIException
     */
    private function listWebhookEndpointsIndividual(string|array|null $organizationId = null, ?int $page = null, ?int $limit = null, ?Options $options = null): Operations\WebhooksListWebhookEndpointsResponse
    {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\Pago\Models\Components\ListResourceWebhookEndpoint', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
     ...
     * @param  ?int  $page
     * @param  ?int  $limit
     * @return \Generator<\Pago\Models\Operations\WebhooksListWebhookEndpointsResponse>
     * @throws \Pago\Models\Errors\APIException
     */
     ...
     *
     * @param  string  $id
     * @return \Pago\Models\Operations\WebhooksRedeliverWebhookEventResponse
     * @throws \Pago\Models\Errors\APIException
     */
     ...
     *
     * @param  string  $id
     * @return \Pago\Models\Operations\WebhooksResetWebhookEndpointSecretResponse
     * @throws \Pago\Models\Errors\APIException
     */
     ...
     * **Scopes**: `webhooks:write`
     *
     * @param  \Pago\Models\Components\WebhookEndpointUpdate  $webhookEndpointUpdate
     * @param  string  $id
     * @return \Pago\Models\Operations\WebhooksUpdateWebhookEndpointResponse
     * @throws \Pago\Models\Errors\APIException
     */
